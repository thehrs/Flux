...
/// The FxAppBar displays the toolbar widgets, [leading], [title], and [actions],
...
class FxAppBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// [actionsIconTheme], or [textTheme] are null, then their FxAppBarTheme
  /// values will be used. If the corresponding FxAppBarTheme property is null,
  ...
  ///
  /// A flexible space isn't actually flexible unless the [FxAppBar]'s container
  /// changes the [FxAppBar]'s size.
  ///
  ...
  /// used by SliverFxAppBar to animate the opacity of the toolbar when the app
  /// bar is scrolled.
  ...
  @override
  _FxAppBarState createState() => _FxAppBarState();
}
    ...
    if (title != null) {
      ...
      title = DefaultTextStyle(
        ...
        child: Semantics(
          ...
          child: FxAppBarTitleBar(child: title),
          header: true,
        ),
      );
    }
...
// Layout the FxAppBar's title with unconstrained height, vertically
// center it within its (NavigationToolbar) parent, and allow the
// parent to constrain the title's actual height.
class FxAppBarTitleBar extends SingleChildRenderObjectWidget {
  const FxAppBarTitleBar({Key? key, required Widget child})
      : super(key: key, child: child);

  @override
  RenderFxAppBarTitleBar createRenderObject(BuildContext context) =>
      RenderFxAppBarTitleBar(
        textDirection: Directionality.of(context),
      );

  @override
  void updateRenderObject(
      BuildContext context, RenderFxAppBarTitleBar renderObject) {
    renderObject.textDirection = Directionality.of(context);
  }
}

class RenderFxAppBarTitleBar extends RenderAligningShiftedBox {
  RenderFxAppBarTitleBar({
    RenderBox? child,
