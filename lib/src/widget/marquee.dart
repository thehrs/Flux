...
class FxMarquee extends StatefulWidget {
  final String text;
  ...
  @override
  FxMarqueeState createState() => FxMarqueeState();
}

class FxMarqueeState extends State<FxMarquee>
  ...
  void didChangeDependencies() {
    ...
    blankWidth =
        MediaQuery.of(context).size.width * widget.ratioOfBlankToScreen;
    blankHeight =
        MediaQuery.of(context).size.height * widget.ratioOfBlankToScreen;
  }
...
extension MarqueeExtension on String {
  ///
  /// Extension method to directly access [FxMarquee] with any widget without wrapping or with dot operator.
  ///
