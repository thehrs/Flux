...
import 'package:flux/src/widget/divider.dart';
...
class _FxBottomSheetOptions extends StatelessWidget {
  final List<String>? list;
  final String? initData;
  final double? maxHeight;
  final double? minHeight;

  const _FxBottomSheetOptions({
    this.list,
    this.initData,
    this.maxHeight,
    this.minHeight,
...
class _FxBottomSheetView extends StatelessWidget {
  final Widget? child;
  final double? maxHeight;
  final double? minHeight;

  const _FxBottomSheetView({
    this.child,
    this.maxHeight,
    this.minHeight,
  });
