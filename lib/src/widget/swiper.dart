...
/// Use this widget [FxSwiper] to give your list a swipeable effect with full customization.
class FxSwiper extends StatefulWidget {
  FxSwiper(
  ...
  /// The initial page to show when first creating the [FxSwiper].
  ///
  /// Defaults to 0.
  ...
  /// Animates the controlled [FxSwiper] to the next page.
  ///
  ...
  /// Animates the controlled [FxSwiper] to the previous page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
  ...
  /// Changes which page is displayed in the controlled [FxSwiper].
  ///
  ...
  /// Animates the controlled [FxSwiper] from the current page to the given page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
  ...
  @override
  _FxSwiperState createState() => _FxSwiperState();
}

class _FxSwiperState extends State<FxSwiper> with TickerProviderStateMixin {
  Timer? timer;
